        ...
        <div className="mx-auto max-w-7xl px-4 py-4 sm:px-6 lg:px-8">
          <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
            ...
            <div className="flex flex-wrap items-center gap-3 xl:justify-end">
              <div className="inline-flex items-center gap-2 rounded-full border border-emerald-500/25 bg-emerald-500/10 px-3 py-2 font-mono text-[10px] uppercase tracking-[0.16em] text-white">
              ...
              <div className="hidden min-w-[240px] rounded-xl border border-slate-600 bg-slate-900/55 px-4 py-2 lg:block">
                <p className="font-mono text-[10px] uppercase tracking-[0.16em] text-slate-300">Current workspace</p>
                <p className="truncate text-sm font-semibold text-white">{displayWorkspaceName}</p>
              </div>

              <Link
                href="/quotes/new"
                className="inline-flex items-center justify-center rounded-lg border border-sky-500 bg-sky-600 px-4 py-2 font-mono text-[11px] uppercase tracking-[0.16em] text-white transition hover:border-sky-400 hover:bg-sky-500 !text-white"
              >
                New quote
              </Link>
